<?php
    ...
    $q="SELECT `o_id`, `products`, `quantity`, `price`, `status`, `email`, `house_no`, `apartment_name`, `area`, `city`, `pin_code` FROM `ordertable` ";
  ...
  $i=0;
    $q= 0;
    echo "<h3><b><u>Products: <br></u></b> </h3>";
    ...
    foreach ($p_unsr as $pvalue) {
       ...
       while($row= mysqli_fetch_assoc($result)){
           ...
           echo $product_name."<b>(".$q_unsr[$i].")</b>,<hr>";
