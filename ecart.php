...
h2{
    ...
    <div class="container-fluid">
                   ...
                   <?php
                                     ...
                                     */
                                        ...
                                        <script>
                                           ...
                                           img.setAttribute("src","72/UPLOAD/<?php echo $row['img'];?>  ");
                                            ...
                                            h1.innerHTML= "<b><u>PRODUCT NAME</u></b><br><br><?php echo $row['PRODUCT_NAME']; ?>";
                                            d2.appendChild(h1);
                                            ...
                                            dd2.innerHTML="<b><u>PRICE</u></b><br><?php echo $row['PRICE']; ?>";
                                            dd1.appendChild(dd2);
                                           ...
                                           /* var dd3=document.createElement('div');
                                            ...
                                            dd4.innerHTML="<b><u>QUANTITY</u></b><br><?php echo $q; ?>";
                                            dd1.appendChild(dd4);
                              ...
                              echo "<center><h2><u>Total Price: </u>$total_price </h2></center>";
                              session_start();
      ...
      ?>                  
                ...
                <center>   <a  href="address.php" class="aa" name = "submit"><b>Buy Now</b></a></center>
    </body>
</html>