...
body{
    ...
    <div class="col-sm-5 py-3">
                    ...
                    <form action="forgot2u.php" method="POST">
                        
                        
                        
                        <div class="col-sm-10 py-5">
                            <h5>Email </h5>
                            <input type="email" class="form-control py-2" id="username"   name="Email"    aria-describedby="emailHelp">
             
                        </div>
                       
                        <div class="col-sm-6 py-4">
                            <button type="submit" class="btn btn-primary ">SEND OTP</button></div>
                            </div>
