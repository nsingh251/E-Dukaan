                 ...
                 <div class="row">
                  <div class="col-md-12 text-center marb-35">
                   ...
                   <div class="col-md-12 text-center" id="menu-filter">
                    ...
                    <li><a class="filter active"  style=" font-family: 'Permanent Marker', cursive; font-size: 20px;">Show all</a></li>
                        ...
                        $shopid=$_SESSION['shopid'];
                             $conn=mysqli_connect("localhost","root","","retailDatabase");
                                if(!$conn)
                                  ...
                                  $sql= "SELECT `P_ID`,`PRODUCT_NAME`,`PRICE`, `STOCK` FROM `addproduct` WHERE `SHOP_ID`= '$shopid' ";
